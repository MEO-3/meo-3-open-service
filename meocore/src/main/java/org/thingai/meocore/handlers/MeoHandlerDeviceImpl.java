package org.thingai.meocore.handlers;
...
public class MeoHandlerDeviceImpl extends MeoHandlerDevice {

    private final Dao<MeoDevice, Integer> deviceDao = new DaoSqlite<>(MeoDevice.class);
    private Thread scanThread;

    public synchronized void scanLanDevice(MeoHandlerDevice.MeoDeviceScanCallback callback, long timeoutSeconds) {
    ...
    public void checkBleDongleStatus(MeoHandlerDevice.MeoDeviceBleDongleStatusCallback callback, int timeoutSeconds) {
    }

    public void scanBleDevice(int dongleEid, MeoHandlerDevice.MeoDeviceScanCallback callback, int timeoutSeconds) {
        if (scanThread != null && scanThread.isAlive()) {
    ...
    public void configureDevice(MeoDeviceInfo deviceInfo, MeoHandlerDevice.MeoDeviceConfigureCallback callback) {
        if (deviceInfo == null) {
