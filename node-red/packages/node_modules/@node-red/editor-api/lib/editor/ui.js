...
var devicesTemplatePath = path.join(editorClientDir,"templates","devices.mst");
var editorTemplate;
var devicesTemplate;
let cacheBuster
...
function getCacheBuster() {
    if (!cacheBuster) {
        // settings.instanceId is set asynchronously to the editor-api being
        // initialised. Defer calculating the hash until the first page render.
...
module.exports = {
    init: function(_settings, _runtimeAPI) {
        ...
        devicesTemplate = fs.readFileSync(devicesTemplatePath,"utf8");
        Mustache.parse(editorTemplate);
        Mustache.parse(devicesTemplate);
    },
    ...
    devices: async function(req,res) {
        var template = process.env.NODE_ENV == "development" ? fs.readFileSync(devicesTemplatePath,"utf8") : devicesTemplate;
